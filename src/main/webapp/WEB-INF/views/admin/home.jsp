									...
									<div class="col-sm-7 infobox-container">		
										...
										<div class="infobox infobox-blue">
											...
											<div class="infobox-data">
												<span class="infobox-data-number">${statistical.totalNews }</span>
												<div class="infobox-content">Bài viết</div>
											</div>

											<div class="stat stat-success">+${statistical.totalNewsTW }</div>
										</div>
										...
										<div class="infobox infobox-green">
											...
											<div class="infobox-data">
												<span class="infobox-data-number">${statistical.totalComment }</span>
												<div class="infobox-content">Bình luận </div>
											</div>

											<div class="stat stat-success">+${statistical.totalCommentTW }</div>
										</div>
										...
										<div class="infobox infobox-pink">
											...
											<div class="infobox-data">
												<span class="infobox-data-number">${statistical.totalAuthor }</span>
												<div class="infobox-content">Tác giả</div>
											</div>
											<div class="stat stat-success">+${statistical.totalAuthorTW }</div>
										...
										<div class="infobox infobox-red">
											...
											<div class="infobox-data">
												<span class="infobox-data-number">${statistical.totalUser }</span>
												<div class="infobox-content">Bạn đọc</div>
											</div>
											<div class="stat stat-success">+${statistical.totalUserTW }</div>
										</div>
										...
										<div class="infobox infobox-orange2">
											...
											<div class="infobox-data">
												<span class="infobox-data-number">${statistical.totalView }</span>
