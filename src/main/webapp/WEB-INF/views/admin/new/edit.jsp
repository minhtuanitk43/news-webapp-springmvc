...
<c:url var="newURL" value="/quan-tri/bai-viet/danh-sach?page=1&limit=5" />
							...
							<div class="form-group">
								...
								<div class="col-sm-9 py-3">
									...
									<form:input type="file" path="thumbnail"
										class="col-xs-10 col-sm-5" onchange="readURL(this);"
										id="thumbnail"/>
									<img width="200" class="img-thumbnail p-3" alt="" 
										src="<c:url value='${pageContext.request.contextPath}/image/${model.thumbnail}'/>" 
										id="imgThumbnail">
								</div>
							</div>
